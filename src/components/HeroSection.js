...
export default function HeroSection() {
    return (
        <section 
            className="px-4 py-8 w-full max-w-6xl mx-auto rounded-xl overflow-hidden relative"
            style={{
            ...
            <div className="p-6 bg-white/70 rounded-lg shadow-md">
                ...
                <div className="space-y-4 md:space-y-6">
                    <div className="grid gap-4 md:gap-6">
                        ...
                        <div className="bg-white/90 backdrop-blur-sm rounded-lg p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow" style={{ borderColor: 'var(--baby-powder)', borderWidth: '1px' }}>
